...
add_noun!("nagyana", "grandmother", difficulty = EASY, category = FAMILY)
...
add_noun!("bácsi", ["elderly man", "old man"], difficulty = EASY, category = FAMILY)
add_noun!("néni", ["elderly woman", "old lady"], difficulty = EASY, category = FAMILY)
...
add_noun!("toll", "pen", difficulty = EASY, category = HOME)
